...
class NodeWidgetManager():
    ...
    def view_config(self, instance):
        ...
        custom_entry_button = Button(text="Set", size_hint_x=1/5, on_press=self.plugin_player.node_manager.link_property_type)
        
        #add button to view the class types
        class_types_button = Button(text="Class Types", size_hint_x = 1/5, on_press=self.plugin_player.utility_manager.class_types)
        ...
        self.plugin_player.create_popup(scroll_view, f'Configuration for {module_name} ({node_number})', True)
        return
    ...
    def add_input(self, instance):
        ...
        custom_entry_button = Button(text="Set", size_hint_x=1/10, on_press=self.plugin_player.node_manager.link_input)
        ...
        class_types_button = Button(text = "Class Types", size_hint_x=3/10, on_press=self.plugin_player.utility_manager.class_types)
        ...
        for node_iter in self.plugin_player.nodes:
            ...
            for output in list(node_iter.output_dict.keys()):
                ...
                add_button = Button(text="Set", size_hint_x=1/10, on_press=self.plugin_player.node_manager.link_input)
        ...
        self.plugin_player.popup = Popup(content=scroll_view, size_hint=(None,None), size=(800,500), 
    ...
    def add_submod(self, instance):
        ...
        for plugin in self.plugin_player.savedPlugins:
            ...
            for module in plugin.modules:
                ...
                add_button = Button(text="Set", size_hint_x=1/10, on_press=self.plugin_player.node_manager.link_submod)
                #add id to identify the submodule from the node, and the module to be the submodule
        ...
        self.plugin_player.create_popup(scroll_view, f'Selecting submodule: {key}', False)